      ...
      <div className="container mx-auto px-6 py-16 lg:py-20">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <h2 className="font-serif font-bold text-2xl tracking-widest mb-6">RAR</h2>
          ...
          <div>
            ...
            <div className="flex flex-col gap-4">
              <a href={`mailto:${contact.info.email}`} className="flex items-center gap-3 text-sm font-light opacity-70 hover:opacity-100 transition-opacity">
                <Mail className="h-4 w-4" />
                {contact.info.email}
              </a>
              <a href={`https://wa.me/${toWaNumber(contact.info.phone)}`} className="flex items-center gap-3 text-sm font-light opacity-70 hover:opacity-100 transition-opacity">
                <Phone className="h-4 w-4" />
                {contact.info.phone}
              </a>
              <a href={contact.info.instagram_url} target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm font-light opacity-70 hover:opacity-100 transition-opacity">
                <Instagram className="h-4 w-4" />
                {contact.info.instagram_handle}
              </a>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16 pt-8 border-t border-background/20">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-xs font-light opacity-60">
              © 2026 RAR Studio. All rights reserved.
            </p>
